...
def library_assumption(player_0, player_0_matrix,  player_1, player_2, player_3, player_4):
        player_0_matrix[131 + player_0.hand[0]] =  0 #0
        player_0_matrix[131 + deck.on_show[0]] = 0 #0
        if deck.drop != []:
...
def process_final_open(final_open):
    if len(final_open) == 0:
        ...
        print (min_player_key, max_player_key, min_player_value, max_player_value)
        if min_player_value + deck.on_show[0] >= max_player_value:
            return min_player_key
        else:
            return max_player_key
# def bet_or_not(player0, player1, player2, player3, player4):
...
if __name__ == '__main__':
    ...
    # 下注逻辑
    # 下注模型断点
    # print (player_0_matrix)
    # print (player_1_matrix)
    # print (player_2_matrix)
    # print (player_3_matrix)
    # print (player_4_matrix)
    final_open = {}
    ...
    # print (player_0_net_income)
    # print (player_1_net_income)
    # print (player_2_net_income)
    # print (player_3_net_income)
    # print (player_4_net_income)
    
    # sorted_final_open = dict(sorted(final_open.items(), key=lambda x: x[1]))
    # print (sorted_final_open)
    # 开牌
    # 计算收益并汇总成训练样本